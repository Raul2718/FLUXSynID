...
from models.mtcnn.detect_face import detect_face, extract_face
...
class MTCNN(nn.Module):
    ...
    def detect(self, img, landmarks=False):
        ...
        for box, point in zip(batch_boxes, batch_points):
            ...
            if len(box) == 0:
                ...
                box_order = box_order[:1]  # fix bug when multiple landmarks are returned for an image
                box = box[box_order]
    ...
    def select_boxes(
        self, all_boxes, all_probs, all_points, imgs, method="probability", threshold=0.9, center_weight=2.0
    ):
